...
@RestController
@RequestMapping("/api/jdocker-kafka")
public class JdockerKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JdockerKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JdockerKafkaResource(KafkaProperties kafkaProperties) {
